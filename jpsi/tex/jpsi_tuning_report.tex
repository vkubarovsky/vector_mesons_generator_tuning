...
3 & 4.048 & 3.152 & 4.128 & 3.170 & 17.6/8 \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
1 & [0.029, 0.071] & [4.202, 4.256] & 0.1009 & 0.1463 & 0.1184 & 0.1406 & 7 \\
2 & [0.018, 0.047] & [4.320, 4.387] & 0.1140 & 0.1101 & 0.1096 & 0.1386 & 11 \\
3 & [0.016, 0.043] & [4.426, 4.487] & 0.0870 & 0.1090 & 0.1127 & 0.1313 & 15 \\
\bottomrule
\end{tabular}
\end{table}
...
The tuned $J/\psi$ generator parameters are $\alpha_2 = 4.13$, $m_g^2 = 3.17$~GeV$^2$ ($\alpha_3 = 0.32$, $\nu_T = 3.0$, $c_R = 0.4$ fixed), $\chi^2 = 17.6$ for 8~ndf. The data prefer a much steeper threshold rise and a flatter
