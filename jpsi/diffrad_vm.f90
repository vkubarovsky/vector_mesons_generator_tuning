...
!                                      bt=1.284  cR=1.0
!       jpsi (ivec=4, dipole t):       alf2=4.250  alf3=0.32  nuT=3.0
!                                      mg2=4.055 cR=0.4
!       (jpsi retuned 2026-06-12: single-fastMC acceptance,
!        F18in_45nA @10.6 GeV + S19in_50nA @10.2 GeV; chi2=20.4/8)
...
!     --- J/psi only: dipole mass^2 (tuned 2026-06) ---
      pars(29) = param_t('mg2',   1,1, 4.055d0,0d0,0, 0.1d0,100d0, .false.)
