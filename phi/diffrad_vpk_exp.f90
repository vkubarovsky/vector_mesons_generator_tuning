...
!     --- phi model parameters (use defaults if not set in input) ---
...
!       Jpsi: dipole 1/(amg2-t)^4 — matches sigma_T_jpsi
        amg2 = 1.6d0       ! matches mg2 in sigma_T_jpsi
...
!
      ...
      parameter( alf1  = 400.d0        )
      parameter( alf2  =   0.1d0       )
      parameter( alf3  =  -8.0d0       )
      parameter( nuT   =   0.2d0       )
      parameter( mg2   =   3.0d0       )  ! [GeV²]
      parameter( cR    =   1.0d0       )
!     -----------------------------
      if(xB.le.0d0 .or. xB.ge.1d0 .or. q2.le.0d0)then
