...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{plots/rgafall18_inb_step2_fastmc.png}
\caption{Generated vs.\ accepted distributions after fast MC for RGA Fall 2018, inbending.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{plots/rgafall18_outb_step2_fastmc.png}
\caption{Generated vs.\ accepted distributions after fast MC for RGA Fall 2018, outbending.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{plots/rgasp18_inb_step2_fastmc.png}
\caption{Generated vs.\ accepted distributions after fast MC for RGA Spring 2018, inbending.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{plots/rgasp18_outb_step2_fastmc.png}
\caption{Generated vs.\ accepted distributions after fast MC for RGA Spring 2018, outbending.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{plots/rgasp19_inb_step2_fastmc.png}
\caption{Generated vs.\ accepted distributions after fast MC for RGA Spring 2019, inbending.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{plots/rgafall18_inb_step5_fit.png}
\caption{Pipeline step 5: acceptance-corrected fit for RGA Fall 2018, inbending (raw counts, not M(KK) signal extraction).}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{plots/rgafall18_outb_step5_fit.png}
\caption{Pipeline step 5: acceptance-corrected fit for RGA Fall 2018, outbending (raw counts, not M(KK) signal extraction).}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{plots/rgasp18_inb_step5_fit.png}
\caption{Pipeline step 5: acceptance-corrected fit for RGA Spring 2018, inbending (raw counts, not M(KK) signal extraction).}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{plots/rgasp18_outb_step5_fit.png}
\caption{Pipeline step 5: acceptance-corrected fit for RGA Spring 2018, outbending (raw counts, not M(KK) signal extraction).}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{plots/rgasp19_inb_step5_fit.png}
\caption{Pipeline step 5: acceptance-corrected fit for RGA Spring 2019, inbending (raw counts, not M(KK) signal extraction).}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{plots/rgafall18_inb_step1_generated.png}
\caption{Generated kinematics for RGA Fall 2018, inbending.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{plots/rgafall18_outb_step1_generated.png}
\caption{Generated kinematics for RGA Fall 2018, outbending.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{plots/rgasp18_inb_step1_generated.png}
\caption{Generated kinematics for RGA Spring 2018, inbending.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{plots/rgasp18_outb_step1_generated.png}
\caption{Generated kinematics for RGA Spring 2018, outbending.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{plots/rgasp19_inb_step1_generated.png}
\caption{Generated kinematics for RGA Spring 2019, inbending.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{plots/rgafall18_inb_step3_mc_vs_data.png}
\caption{MC vs.\ data kinematic comparison for RGA Fall 2018, inbending.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{plots/rgafall18_outb_step3_mc_vs_data.png}
\caption{MC vs.\ data kinematic comparison for RGA Fall 2018, outbending.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{plots/rgasp18_inb_step3_mc_vs_data.png}
\caption{MC vs.\ data kinematic comparison for RGA Spring 2018, inbending.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{plots/rgasp18_outb_step3_mc_vs_data.png}
\caption{MC vs.\ data kinematic comparison for RGA Spring 2018, outbending.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{plots/rgasp19_inb_step3_mc_vs_data.png}
\caption{MC vs.\ data kinematic comparison for RGA Spring 2019, inbending.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{plots/rgafall18_inb_step4_acceptance.png}
\caption{Acceptance maps for RGA Fall 2018, inbending.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{plots/rgafall18_outb_step4_acceptance.png}
\caption{Acceptance maps for RGA Fall 2018, outbending.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{plots/rgasp18_inb_step4_acceptance.png}
\caption{Acceptance maps for RGA Spring 2018, inbending.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{plots/rgasp18_outb_step4_acceptance.png}
\caption{Acceptance maps for RGA Spring 2018, outbending.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{plots/rgasp19_inb_step4_acceptance.png}
\caption{Acceptance maps for RGA Spring 2019, inbending.}
\end{figure}
